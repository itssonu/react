...
!(function (e, t) {
      ...
      return (
        ...
        (t._fixScrollHeight = function () {
          ...
          if (e.hasClass(A)) {
            ...
            l && s
              ...
              : (l || s) && (r.css("height", "100%"), r.css("height", ""));
          }
        }),
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              (a || ((a = new e(this, i)), n.default(this).data(j, a)),
              "undefined" === a[t])
            )
      ...
      return (
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            a || ((a = new e(n.default(this))), n.default(this).data(N, a)),
              a[t]();
          });
        }),
        e
  ...
  n
    ...
    .on("click", function (e) {
      e.preventDefault(),
        e.stopPropagation(),
        G._jQueryInterface.call(n.default(this), "toggleSubmenu");
    }),
      ...
      return (
        ...
        (e._jQueryInterface = function (t) {
          ...
          n.default(this).data(ne, "object" == typeof t ? t : a),
            "string" == typeof t && /toggle|fullscreen|windowed/.test(t)
              ? o[t]()
              : o.init();
        }),
        e
    ...
    Qe = (function () {
      ...
      return (
        ...
        (t.createTab = function (e, t, a, i) {
          ...
          var r =
            '<li class="nav-item" role="presentation"><a href="fake_url" class="btn-iframe-close" data-widget="iframe-close" data-type="only-this"><i class="fas fa-times"></i></a><a class="nav-link" data-toggle="row" id="' +
            l +
            '" href="#' +
            s +
        ...
        (t.openTabSidebar = function (e, t) {
          ...
          if ("#" !== o && "" !== o && void 0 !== o) {
            var s = o
                ...
                .replace(/(--)/gi, ""),
              l = "tab-" + s;
            if (!this._config.allowDuplicates && n.default("#" + l).length > 0)
              return this.switchTab("#" + l);
            ((!this._config.allowDuplicates &&
              0 === n.default("#" + l).length) ||
              this._config.allowDuplicates) &&
              this.createTab(i, o, s, t);
          }
        }),
        (t.switchTab = function (e) {
          ...
          n.default(ye).hide(),
            ...
            this._config.autoItemActive &&
              this._setItemActive(n.default(a + " iframe").attr("src"));
        }),
        ...
        (e._jQueryInterface = function (t) {
          ...
          if (
            (a || ((a = new e(this, i)), n.default(this).data(de, a)),
            "string" == typeof t &&
      ...
      return (
        (t.fixLayoutHeight = function (e) {
          ...
          var i = {
              ...
              footer:
                n.default(Le).length > 0 ? n.default(Le).outerHeight() : 0,
          ...
          !1 !== s &&
            (o === i.controlSidebar
              ...
              ? l.css(
                  ...
                  o + s - i.header - i.footer
                )
              : l.css(this._config.panelAutoHeightMode, o + s - i.header),
            this._isFooterFixed() &&
              l.css(
                this._config.panelAutoHeightMode,
                parseFloat(l.css(this._config.panelAutoHeightMode)) + i.footer
              )),
  ...
  var qe = "PushMenu",
    ...
    Ke = (function () {
      function e(e, t) {
        (this._element = e),
          (this._options = n.default.extend({}, Je, t)),
      ...
      return (
        (t.expand = function () {
          ...
          this._options.autoCollapseSize &&
            ...
            this._options.enableRemember &&
              localStorage.setItem("remember" + Oe, We),
            n
              .default(this._element)
        ...
        (t.collapse = function () {
          ...
          this._options.autoCollapseSize &&
            n.default(window).width() <= this._options.autoCollapseSize &&
            e.removeClass(We).addClass(Ge),
            e.addClass($e),
            this._options.enableRemember &&
              localStorage.setItem("remember" + Oe, $e),
            n
              .default(this._element)
        ...
        (t.autoCollapse = function (e) {
          if ((void 0 === e && (e = !1), this._options.autoCollapseSize)) {
            var t = n.default(Be);
            n.default(window).width() <= this._options.autoCollapseSize
              ? t.hasClass(We) || this.collapse()
              : !0 === e &&
                (t.hasClass(We)
                  ? t.removeClass(We)
                  : t.hasClass(Ge) && this.expand());
          }
        }),
        (t.remember = function () {
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            a || ((a = new e(this, i)), n.default(this).data(Ne, a)),
              "string" == typeof t &&
        ...
        (a.search = function () {
          ...
          n.default(ft).empty(),
            0 === i.length
              ...
              : i.each(function (t, a) {
                  n.default(ft).append(
                    e._renderItem(escape(a.name), escape(a.link), a.path)
                  );
                }),
            this.open();
        }),
      ...
      return (
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            a || ((a = new e(n.default(this), i)), n.default(this).data(At, a)),
              "init" === t && a[t]();
          });
        }),
        e
