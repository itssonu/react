    ...
    /******/ {
      ...
      /***/ 51: /***/ function (
            ...
            if (this.options.trigger !== "manual") {
              ...
              this.options.trigger.split(" ").forEach(function (eventName) {
                if (eventName === "hover") {
                  ...
                  $node
                    .on("mouseenter", showCallback)
                    .on("mouseleave", hideCallback);
          ...
          _createClass(TooltipUI, [
            {
              ...
              value: function show() {
                ...
                var title =
                  ...
                  $node.data("title");
                var placement =
                  this.options.placement || $node.data("placement");
        ...
        function DropdownUI_createClass(Constructor, protoProps, staticProps) {
          if (protoProps)
            DropdownUI_defineProperties(Constructor.prototype, protoProps);
          if (staticProps)
            DropdownUI_defineProperties(Constructor, staticProps);
          return Constructor;
        }
        ...
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
          document
        ).on("click.note-dropdown-menu", function (e) {
          external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
            e.target
          )
        ...
        function ModalUI_createClass(Constructor, protoProps, staticProps) {
          if (protoProps)
            ModalUI_defineProperties(Constructor.prototype, protoProps);
        ...
        var ui_button = renderer["a" /* default */].create(
          ...
          function ($node, options) {
            var markup = Array.isArray(options.items)
              ? options.items.map(function (item) {
                  ...
                  var $temp =
                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                      '<a class="note-dropdown-item" href="fake_url" data-value="' +
                        value +
        ...
        var palette = renderer["a" /* default */].create(
        ...
        var videoDialog = function videoDialog(opt) {
          var body =
            ...
            "</div>";
          var footer = [
            '<button type="button" href="fake_url" class="note-btn note-btn-primary note-video-btn disabled" disabled>',
        ...
        var imageDialog = function imageDialog(opt) {
          var body =
            ...
            "</div>";
          var footer = [
            '<button href="fake_url" type="button" class="note-btn note-btn-primary note-btn-large note-image-btn disabled" disabled>',
        ...
        var linkDialog = function linkDialog(opt) {
          var body =
            ...
            "</label></div>";
          var footer = [
            '<button href="fake_url" type="button" class="note-btn note-btn-primary note-link-btn disabled" disabled>',
